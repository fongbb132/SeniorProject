...
def create_lists_of_data(energy_data, encoder_insize=24*5*1, decoder_insize=24*1*1):
	"""
...
def separate_enc_dec(enc_dec_data, encoder_insize=24*5*1, decoder_insize=24*1*1):
	"""
